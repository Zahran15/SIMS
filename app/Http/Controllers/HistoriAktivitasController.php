...
class HistoriAktivitasController extends Controller
{
    ...
    {
        $query = HistoriAktivitas::with(['user','servis.booking.pelanggan']);
    ...
    {
        $histori = HistoriAktivitas::with(['user', 'servis.booking.pelanggan', 'servis.detailJasa.jasa', 'servis.detailSparepart.sparepart'])->findOrFail($id);
