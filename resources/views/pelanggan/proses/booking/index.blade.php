...
<div class="mb-8 flex justify-between items-end">
    <div>
        <h2 class="text-3xl font-bold text-gray-800">Booking Saya</h2>
        <p class="text-gray-500 mt-1">Pantau dan kelola riwayat pengajuan booking servis Anda</p>
    </div>

    {{-- BUTTON TAMBAH --}}
    <a href="{{ route('pelanggan.booking.create') }}"
        class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-xl shadow-lg shadow-blue-200 transition-all font-semibold">
        Buat Booking Baru
    </a>
</div>
                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-5 py-5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                {{-- Tombol Detail (Selalu Bisa Diakses) --}}
                                <a href="{{ route('pelanggan.booking.show', $b->id_booking) }}"
                                ...
                                {{-- EDIT --}}
                                @if($b->status_booking == 'pending' && $b->status_dp == 'belum lunas')
                                    {{-- Muncul JIKA belum bayar dan belum diproses --}}
                                    <a href="{{ route('pelanggan.booking.edit', $b->id_booking) }}"
                                ...
                                <form action="{{ route('pelanggan.booking.destroy', $b->id_booking) }}" 
                                    method="POST"
                ...
                @empty
                    <tr>
                        <td colspan="8"
                            ...
                            Anda belum pernah melakukan booking servis.
                        </td>
                    </tr>
                @endforelse
            </tbody>
