...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-bold text-gray-800">Servis Selesai</h2>
            <p class="text-gray-500 mt-1">
                Data servis yang telah selesai atau sudah diambil pelanggan
            </p>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($servis as $index => $s)
                        <tr class="border-b hover:bg-gray-50 transition-all">
                            ...
                            <td class="px-5 py-4 text-center font-bold text-green-600">{{ $s->kode_servis }}</td>
                            ...
                            <td class="px-5 py-4 text-center">
                                ...
                                @elseif($s->status_servis == 'bisa diambil')
                                    <span class="px-3 py-1 text-xs rounded-full bg-yellow-100 text-yellow-700 font-semibold">Bisa Diambil</span>
                                @elseif($s->status_servis == 'sudah diambil')
                                    <span class="px-3 py-1 text-xs rounded-full bg-green-100 text-green-700 font-semibold">Sudah Diambil</span>
                                @endif
                            </td>
