        ...
        <form action="{{ route('admin.pengadaan_tools.store') }}" method="POST">
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_tools" placeholder="Contoh: Solder IC, Obeng Set" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah" value="1" min="0" placeholder="0"
                    ...
                    {{-- STATUS TOOLS --}}
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Status Awal Tools *</label>
                        <select name="status" class="w-full border @error('status') border-red-500 focus:ring-red-100 focus:border-red-500 @else border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 @enderror rounded-xl p-3 outline-none transition appearance-none bg-no-repeat text-gray-700" style="background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%20fill%3D%22none%22%20stroke%3D%22%23cbd5e1%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E'); background-position: right 0.75rem center; background-size: 1.2em;" required>
