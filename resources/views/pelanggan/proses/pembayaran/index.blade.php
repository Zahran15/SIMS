                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-5 py-5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                {{-- TAMBAHAN: BUTTON BAYAR (Hanya muncul jika status Belum Lunas/Sukses) --}}
                                @if($item->status_pembayaran != 'sukses')
                                    <a href="{{ route('pelanggan.pembayaran.detail', $item->id_pembayaran) }}"
                                       class="w-9 h-9 flex items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-600 hover:text-white transition-all" 
