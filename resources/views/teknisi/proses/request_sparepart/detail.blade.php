...
@section('content')
    ...
    <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b pb-3">
        <div>
            ...
            <p class="text-gray-500 text-xs">Informasi lengkap status dan rincian pengajuan komponen perbaikan perangkat.</p>
        </div>
        
        <div class="flex items-center gap-2">
            <a href="{{ route('teknisi.request_sparepart.index') }}" 
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded border border-gray-200 shadow-sm">
            ...
            {{-- Info Administratif & Keluhan (Baris 2) --}}
        ...
        {{-- BLOK 2: TABEL RINCIAN KOMPONEN YANG DIAJUKAN (UPDATE: TAMBAH HARGA) --}}
        <div class="bg-white rounded border border-gray-200 shadow-sm overflow-hidden">
            <div class="px-4 py-2 border-b bg-gray-50">
                <h3 class="font-bold text-gray-700 uppercase text-xs tracking-wide">Detail Komponen & Estimasi Harga</h3>
            </div>
                ...
                <table class="w-full text-xs text-left text-gray-600 table-fixed">
                    <thead class="bg-gray-100 uppercase font-bold text-gray-600 border-b">
                        <tr>
                            ...
                            <th class="w-3/12 px-4 py-2 text-right">Total Estimasi</th>
                        </tr>
                    </thead>
